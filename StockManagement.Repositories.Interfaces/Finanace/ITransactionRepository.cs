...
namespace StockManagement.Repositories.Interfaces.Finanace
{
    ...
    {
        Task<int> CreateExpenseAsync(int currentUserId, TransactionDetailDto transactionDetailDto);
        ...
        Task<bool> UpdateExpenseAsync(int currentUserId, TransactionDetailDto transactionDetailDto);
