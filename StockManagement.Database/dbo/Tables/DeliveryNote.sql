CREATE TABLE [dbo].[DeliveryNote] (
    ...
    CONSTRAINT [FK_DeliveryNote_Location] FOREIGN KEY ([LocationId]) REFERENCES [dbo].[Location] ([Id]),
    CONSTRAINT [FK_DeliveryNote_Transaction] FOREIGN KEY ([TransactionId]) REFERENCES [finance].[Transaction] ([Id])
);
